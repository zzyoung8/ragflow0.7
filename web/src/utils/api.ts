...
export default {
  ...
  current_user: `${api_host}/user/current_user`,
  resetPassword: `${api_host}/user/reset_password`,
  ...
  get_shared: `${api_host}/kb/getShared`,
  change_shared: `${api_host}/kb/changeShare`,
  ...
  // user manage
  listUser: `${api_host}/permission/list`,
  changeUserStatus: `${api_host}/permission/userStatus`,

  // manage Kb Permission: `${api_host}/permission/knowledge`,
  getPermission: `${api_host}/permission/getPermission`,
  setPermission: `${api_host}/permission/setPermission`,
  
  checkPermission: `${api_host}/permission/checkPermission`,
  getAllPermissions: `${api_host}/permission/getAllPermissions`,
  deletePermission:  `${api_host}/permission/deletePermission`,
