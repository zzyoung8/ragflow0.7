export default {
  translation: {
    ...
    knowledgeDetails: {
      shareKnowledgebase: '共享知识库',
      shareKnowledgebaseTip: '是否将该知识库共享',
      dataset: '数据集',
      testing: '检索测试',
      configuration: '配置',
      files: '文件',
      ...
      namePlaceholder: '请输入名称',
      doc: '文档',
      datasetDescription: '😉 解析成功后才能问答哦；doc、xls文件请另存为docx、xlsx文件进行解析；PPT等文件请导出为PDF文件进行解析 😉',
      addFile: '新增文件',
      searchFiles: '搜索文件',
      localFiles: '本地文件',
      emptyFiles: '新建空文件',
    ...
    knowledgeConfiguration: {
      chunkOverlap: 'Chunk重复比率',
      chunkOverlapTip: '上下文的重复比率',
...
以上就是你需要总结的内容。`,
    ...
    chat: {
      ...
      operation: '操作',
      model: '模型',
      modelTip: '大语言聊天模型，注：商业大模型若未配置API-Key则需联网申请才能使用；由Ollama提供的本地模型yi:6b 、yi:9b需先手动配置，配置方法详见操作手册。',
      modelMessage: '请选择',
      freedom: '自由',
      improvise: '即兴创作',
      precise: '精确',
    ...
    setting: {
      ...
      photo: '头像',
      photoDescription: '这将显示在您的个人资料上。(图片建议小于50K)',
      colorSchema: '主题',
